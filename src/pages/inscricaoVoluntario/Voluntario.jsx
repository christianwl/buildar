...
// import Footer from '../headersEfooters/footer-pre-login/Footer';
    ...
    <main id="voluntario">
      ...
      <div className="ContainerVoluntarioMain">
        <div id="titulo">
          <h1
            id="animated-title"
            aria-label="Título animado da página"
            aria-live="polite"
          >
          ...
          <p>
            Quer impactar a vida dos jovens com suas habilidades? Seja
            voluntário e ajude a construir o futuro! Compartilhe seus
            conhecimentos, inspire com suas experiências e contribua para um
            amanhã melhor. Junte-se a nós nesta jornada transformadora!
          </p>
        </div>
